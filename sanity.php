  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
	<!--Work on the cleaning of output, login function-->
  <div class="card-header">
	  <h2>Sanity Checker</h2>
  <form name=ping action=# method=post>
<!--Maybe we can use this to ping our servers!-->
      <p>
      <span>Enter an IP address or URL:</span><br>
 ...
 <?php
  ...
  $get_ip=str_replace($sanitization, "", $_POST['ip']);
  $cmd=shell_exec("ping -c 2 ".$get_ip);
  echo $cmd;
?>
      </p>
  </form>
